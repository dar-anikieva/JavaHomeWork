...
public class Server {
    ...
    static class Handler implements Runnable {
        ...
        public void run() {
            try {
                ...
                System.out.println("Ожидаем отклика");
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Старт сервера порта : " + serverPort);
        ...
        while (true) {
            try {
                ...
                System.out.println("Соединение не устанавливается");
                System.exit(-1);
            }
        }
    }
